...
-- 6. Crear la tabla Productos: cada producto pertenece a una categor�a.
...
-- Modificar la tabla Productos para a�adir la clave for�nea de Proveedores
...
-- Se crea el LOGIN con la contrase�a '2019*'
CREATE LOGIN [Pandas-Sebastian]
    WITH PASSWORD = '2019*', 
    CHECK_POLICY = OFF;
GO

-- ******************************************************
-- 2. Asignar el USUARIO y dar permisos en StockPrueba
-- ******************************************************

USE StockPrueba;
GO

-- Crea el usuario de base de datos y lo vincula al login creado
CREATE USER [Pandas-Sebastian]
    FOR LOGIN [Pandas-Sebastian];
GO

-- Asigna permisos de due�o de la base de datos (control total)
EXEC sp_addrolemember 'db_owner', 'Pandas-Sebastian';
GO